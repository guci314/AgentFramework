...
graph TB
    ...
    style Engine fill:#e1f5fe,color:#000000,stroke:#333333,stroke-width:2px
    ...
    style GlobalState fill:#f3e5f5,color:#000000,stroke:#333333,stroke-width:2px
    style UI color:#000000,stroke:#333333,stroke-width:2px
    style API color:#000000,stroke:#333333,stroke-width:2px
    style StateChecker color:#000000,stroke:#333333,stroke-width:2px
    style Agents color:#000000,stroke:#333333,stroke-width:2px
    style Agent1 color:#000000,stroke:#333333,stroke-width:2px
    style Agent2 color:#000000,stroke:#333333,stroke-width:2px
    style Agent3 color:#000000,stroke:#333333,stroke-width:2px
    style LLM color:#000000,stroke:#333333,stroke-width:2px
    style Storage color:#000000,stroke:#333333,stroke-width:2px
```
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#ffffff', 'primaryTextColor': '#000000', 'primaryBorderColor': '#333333', 'lineColor': '#333333', 'secondaryColor': '#f8f9fa', 'tertiaryColor': '#ffffff', 'background': '#ffffff', 'stateLabelColor': '#000000', 'stateBkg': '#f8f9fa', 'labelBackgroundColor': '#f8f9fa', 'compositeBackground': '#ffffff', 'altBackground': '#ffffff', 'compositeTitleBackground': '#f8f9fa', 'innerEndBackground': '#ffffff', 'specialStateColor': '#000000'}}}%%
stateDiagram-v2
    [*] --> PENDING: 任务创建
...
graph TB
    ...
    style Planner fill:#ffcdd2,color:#000000,stroke:#333333,stroke-width:2px
    style Decider fill:#ffcdd2,color:#000000,stroke:#333333,stroke-width:2px
    style Manager fill:#c8e6c9,color:#000000,stroke:#333333,stroke-width:2px
    style Engine1 color:#000000,stroke:#333333,stroke-width:2px
    style Engine2 color:#000000,stroke:#333333,stroke-width:2px
    style Executor1 color:#000000,stroke:#333333,stroke-width:2px
    style Executor2 color:#000000,stroke:#333333,stroke-width:2px
    style Checker1 color:#000000,stroke:#333333,stroke-width:2px
    style Checker2 color:#000000,stroke:#333333,stroke-width:2px
    style State1 color:#000000,stroke:#333333,stroke-width:2px
    style State2 color:#000000,stroke:#333333,stroke-width:2px
```
