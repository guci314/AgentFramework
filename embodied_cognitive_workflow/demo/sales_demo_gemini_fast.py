#!/usr/bin/env python3
"""
使用Gemini 2.5 Flash的销售数据分析演示 - 启用元认知
测试Gemini的快速性能表现
"""
...
def main():
    """主函数"""
    print("=== 销售数据分析演示（Gemini 2.5 Flash + 启用元认知） ===")
    ...
    # 执行任务
    print(f"\n⚡ 开始执行销售数据分析任务（Gemini 2.5 Flash + 启用元认知）...")
    ...
    print(f"🔧 优化要点: 使用Gemini 2.5 Flash提升速度，启用元认知保证质量")
